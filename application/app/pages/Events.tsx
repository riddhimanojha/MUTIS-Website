...
const FLAGSHIP = [
  ...
  { num: "E.04", title: "The Shade Tree", term: "Spring Term · Annual", desc: "A 25-year, student-run investment initiative — the first of its kind in the UK — where MUTIS teams pitch real 25-year investment theses for capital donated annually by alumni Adam and Sara Franks, in partnership with Alliance Manchester Business School.", foot: "Alliance Manchester Business School" },
];
